...
The nomenclature here tells R we are plotting soildata$Height as a response (~) of the Treatment, group or section. 
...
Now, let's plot it! You should be able to figure out how to do this based on the previous code, but please ask if you are having troubles.
