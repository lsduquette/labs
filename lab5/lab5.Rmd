...
Your new hypothesis is that the height of plants might not just vary by treatment, but by lab section, and some interaction between these. Plot the heights as a reponse of lab section, and write a function to run a two way ANOVA in your script (you can assume the data is normal). **(2 points)** 
