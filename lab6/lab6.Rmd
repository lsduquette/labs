...
However, I have simulated a "depth" variable for our *Hordeum vulgare* data. This represents the depth at which the seeds were initially planted. Both the height and depth are in cm.
...
This will give you a warning, please ignore it. It is related to the math behind calculating a p-value with ties - so far, the largest published is only useful for n<100. Recall how we calculated C for our Kruskal Wallis test in the case of ties.
